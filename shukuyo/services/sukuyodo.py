...
class SukuyodoService:
        ...
        "命": {
            "guidance": {
                ...
                "remedy": {
                    ...
                    "hr": "原典「不宜舉動百事」。安排在穩定的既有業務，不要委派開創性任務。",
                },
            },
            "sutra_career": [
        ...
        "栄": {
            "guidance": {
                ...
                "remedy": {
                    ...
                    "hr": "原典「宜入官拜職、對見大人、興營買賣」。安排在要職或對外業務位置。",
                },
            },
            "sutra_career": [
        ...
        "衰": {
            "guidance": {
                ...
                "remedy": {
                    ...
                    "hr": "原典「唯宜解除諸惡、療病」。安排在問題排除、品管檢測的職位。",
                },
            },
            "sutra_career": [
        ...
        "安": {
            "guidance": {
                ...
                "remedy": {
                    ...
                    "hr": "原典「移徙吉、造作園宅並吉」。安排在需要建立新據點或新制度的位置。",
                },
            },
            "sutra_career": [
        ...
        "成": {
            "guidance": {
                ...
                "remedy": {
                    ...
                    "hr": "原典「宜修道學問、作諸成就法並吉」。安排在有進修機會或專案交付崗位。",
                },
            },
            "sutra_career": [
        ...
        "壊": {
            "guidance": {
                ...
                "remedy": {
                    ...
                    "hr": "原典「宜作鎮壓、降伏怨讎，餘並不堪」。只能安排在處理衝突和危機的位置。",
                },
            },
            "sutra_career": [
        ...
        "友": {
            "guidance": {
                ...
                "remedy": {
                    ...
                    "hr": "原典「宜結交朋友大吉」。安排在需要團隊協作或對外聯繫的位置。",
                },
            },
            "sutra_career": [
    ...
    HR_CANONICAL_MAP = {
        "命": {
            "summary": "原典「不宜舉動百事」。不適合開創性任務，安排在穩定的既有業務",
            "action_advice": "維持既有職責，不要委派新項目",
        },
        "栄": {
            "summary": "原典「宜入官拜職、對見大人、興營買賣」。適合委以要職、對外業務、業務開發",
            "action_advice": "安排在需要對外拓展或向上溝通的位置",
        },
        "衰": {
            "summary": "原典「唯宜解除諸惡、療病」。只適合排除問題和品質把關，其他不吉",
            "action_advice": "安排在問題排除、品管檢測、障礙排解的職位",
        },
        "安": {
            "summary": "原典「移徙吉、入宅、造作園宅並吉」。適合安頓新環境、建立據點和制度",
            "action_advice": "安排在需要建立新據點或新制度的位置",
        },
        "危": {
            "summary": "原典「不宜遠行出入移徙」。不適合頻繁出差或調動，安排在固定崗位",
            "action_advice": "安排在固定據點，不要頻繁調動或派遣出差",
        },
        "成": {
            "summary": "原典「宜修道學問、作諸成就法並吉」。適合學習進修和專案交付型的職位",
            "action_advice": "安排在有進修機會的職位，或需要完成具體專案的崗位",
        },
        "壊": {
            "summary": "原典「宜作鎮壓、降伏怨讎，餘並不堪」。只適合處理衝突和危機，日常業務不行",
            "action_advice": "只能安排在處理衝突、危機應變的位置。日常崗位原典說「不堪」",
        },
        "友": {
            "summary": "原典「宜結交朋友大吉」。團隊合作和社交互動是大吉的",
            "action_advice": "安排在需要團隊協作或對外聯繫的位置",
        },
        "親": {
            "summary": "原典「宜結交、定婚姻、歡宴聚會並吉」。建立長期關係是吉的",
            "action_advice": "適合長期合作，建立穩定關係",
        },
        "業": {
            "summary": "原典「所作善惡亦不成就，甚衰」。短期績效不可期，安排長期累積型工作",
            "action_advice": "不要期待短期成果。安排在不急著要產出的位置",
        },
        "胎": {
            "summary": "原典「不宜舉動百事」。時機未到，適合儲備培養",
            "action_advice": "儲備培養，不要急著要成果",
        },
    }
